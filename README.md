...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   The useRouteMatch hook is used to allow you to create nested routes in your application.
   With this feature, you can change a SINGLE parameter in the URL, without having to change the entire thing.

1. How would you explain form validation to someone who has never programmed before?
   I would tell them that 'form validation' is just a way to ensure the user is entering the
   correct form of data into our input section.

1. In 1-2 sentences, define end to end testing.
   End-to-end testing focuses on the User Interface and mimics how events would be handled on the page.
   It tests the entire UI to see if a User would be able to accomplish ALL the actions on the page.
